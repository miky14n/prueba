...
namespace appPrevencionRiesgos.Services.Security
{
    public class UserService: IUserService
    {
        ...
        public UserService(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, IOptions<MongoDBSettings> mongoDBSettings)
        {
            ...
            _userCollection = database.GetCollection<IdentityUser>(mongoDBSettings.Value.CollectionName);
        }
        ...
        public async Task<UserManagerResponse> RegisterUserAsync(RegisterViewModel model)
        {
            ...
            /*var identityUser = new RegisterViewModel
            {
                Email = model.Email,
            ...
            //await _userCollection.InsertOneAsync(identityUser,model.Password);
             //await _userCollection.InsertOneAsync(identityUser);
